...
(function () {
  ...
  try {
    ...
    var COUNT = 20;                 /* 1–11 зуб в ладонях и уход в свет,
                                       12–20 предметный ряд клиники: инструменты,
                                       бор, скалер, шкала оттенков, коронка,
                                       щипцы, крафт-пакеты, руки и стеклянный зуб.
                                       Снимки кабинетов из скролла убраны — они
                                       живут в разделах, а здесь держим один
                                       минималистичный визуальный ряд. */
