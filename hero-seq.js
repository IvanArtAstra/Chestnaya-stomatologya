...
(function () {
  ...
  try {
    ...
    var COUNT = 11;                 /* 1–3 зуб в ладонях, 4 свет — в него
                                       «ныряем»; дальше клиника: 5 рецепция,
                                       7 кабинет № 1, 9 кабинет № 2,
                                       10 рабочая зона, 11 зона ожидания.
                                       Кадры 6 и 8 — проходы: взгляд из
                                       коридора в следующее помещение, чтобы
                                       камера не прыгала из комнаты в комнату. */
    ...
    var ROOMS = { 4: "room.1", 6: "room.2", 8: "room.3", 9: "room.5", 10: "room.4" };
    var BASE = "hero-seq/";
