...
(() => {
  ...
  try {
    ...
    function init(THREE) {
      ...
      panel("#8b82f5", 3, 8, 3, [-6, 0, 1]);       /* аква слева */
      panel("#7a6cf0", 3, 8, 3, [6, -1, 1]);       /* циан справа */
      panel("#2a2472", 1.5, 10, 6, [0, -6, -2]);   /* глубина снизу */
      ...
      const applyTheme = () => {
        ...
        keyL.color.set(light ? "#4239b8" : "#8b82f5");
        rimL.color.set(light ? "#7a6cf0" : "#7a6cf0");
        ambient.intensity = light ? 0.85 : 0.35;
        renderer.toneMappingExposure = light ? 1.25 : 1.1;
        sparks.material.color.set(light ? "#4239b8" : "#9beee4");
        nerve.material.color.set(light ? "#4239b8" : "#8b82f5");
        nerveLight.color.set(light ? "#4239b8" : "#8b82f5");
      };
      applyTheme();
