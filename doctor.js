...
(() => {
  ...
  /* ── профиль ── */
  /* В команде есть не только врачи: гигиенист, ассистенты и администратор.
     Для них нельзя ни размечать Physician, ни звать «записаться к врачу». */
  const isDoctor = !/ассистент|администратор|гигиенист/i.test(doc.role || "");
