...
(function () {
  ...
  var css = "" +
    ...
    ".tour__dot.is-active{opacity:1;background:var(--aqua);border-color:var(--aqua);transform:scale(1.35);box-shadow:0 0 14px rgba(66, 57, 184,.5);}" +
    ...
    ":root[data-theme=\"light\"] .tour__dot.is-active{box-shadow:0 0 10px rgba(66, 57, 184,.4);}" +
