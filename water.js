  ...
  try {
    ...
    function palette() {
      if (currentTheme() === 'light') {
        return {
          ...
          causticColor1: '66, 57, 184',
          causticColor2: '122, 108, 240',
          causticOpacity: 0.06,
      ...
      return {
        ...
        rayColor: '183, 173, 250',
        rayOpacity: 0.07,                              // 0.04–0.1
        causticColor1: '139, 130, 245',                 // #2dd4bf
        causticColor2: '109, 94, 240',                 // #38bdf8
        causticOpacity: 0.05,
    ...
    function frame(now) {
      ...
      try {
        ...
        // Пузырьки отключены по требованию бренда (светлый фон).
