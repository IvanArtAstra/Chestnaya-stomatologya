  ...
  const SEED = {
    ...
    doctors: [
      ...
      },
      {
        ...
        desc: "Хирургическое лечение: удаление зубов, в том числе сложное, и подготовка к протезированию. Подробно объясняет ход вмешательства до начала работы.",
      ...
      {
        id: "polina",
        name: "Полина Олеговна",
        fullName: "Полина Олеговна",
        role: "Гигиенист",
